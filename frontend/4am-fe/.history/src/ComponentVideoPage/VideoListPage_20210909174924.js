...
const VideoListPage = (props) => {
    ...
    useEffect(()=>{
        if(props.isShownAddVideoForm) {
            document.querySelector('.VideoListPage_video-category-title__LLSL9').style.marginTop='855px';
        } else {
    ...
    return (
        <div className={styles['video-category-page']}>
            ...
            <button type="button" class={addVideoBtnClassName} onClick={props.onShowAddVideoForm}>Thêm video</button>
