  ...
  return (
    <Router>
      <div className="App">
          ...
          {showCreateBlogForm && <CreateBlogForm onHideCreateBlogForm={onHideCreateBlogForm}/>}
          <Header onShowAccountHandler={onShowAccountHandler}/>
          <Switch>
              <Route path="/blog-category/basketball/:id" children={<Blog onShowCreateBlogForm={onShowCreateBlogForm}/>} />
              <Route path="/blog-category/calisthenic/:id" children={<Blog onShowCreateBlogForm={onShowCreateBlogForm}/>} />
