            ...
            <form id="login-form">
                ...
                <div className="form-group mt-4">
                    ...
                    <div className={styles['enter-password-container']}>
                        ...
                        <FaEye id="unhide-btn-0" className={showPassword ? styles['unhide-password-button'] : styles['hide']} onClick={onShowPasswordHandler}/>
...

                {
                    ...
                    <div className="form-group mt-4">
                        ...
                        <div className={styles['enter-password-container']}>
                            ...
                            <FaEye id="unhide-btn-1" className={showEvalPassword ? styles['unhide-password-button'] : styles['hide']} onClick={onShowEvalPasswordHandler}/>
