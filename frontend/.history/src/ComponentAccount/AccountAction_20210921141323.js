...

                {
                    ...
                    <div className="form-group mt-4">
                        ...
                        <div className={styles['enter-password-container']}>
                            ...
                            <FaEye id="unhide-btn-1" className={showEvalPassword ? styles['unhide-password-button'] : styles['hide']} onClick={onShowPasswordHandler}/>
                            <FaEyeSlash id="hide-btn-1" className={showEvalPassword ? styles['hide'] : styles['unhide-password-button']} onClick={onHidePasswordHandler}/>
                        </div>
                    </div>
                }
