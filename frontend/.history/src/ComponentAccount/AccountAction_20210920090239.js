    ...
    return (
        <Modal onClose={props.onHideAccountHandler}>
            ...
            <form>
                ...
                <button type="submit" className={btnPrimaryClassName}>{actionType==='login' ?  'Đăng nhập' : 'Đăng kí' }</button>
                <button type="submit" className={btnSecondaryClassName}>{actionType==='login' ?  'Đăng kí' : 'Đăng nhập' }</button>
