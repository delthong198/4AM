...
const AccountAction = (props) => {
    ...
    var unhidePassControls = document.querySelectorAll(styles['unhide-password-button']);
    console.log(unhidePassControls)
    unhidePassControls.forEach((element, index) => {
        element.addEventListener('click', ()=> {
            document.querySelector(`.pass${index}`).type = "text";
            document.querySelector(`.unhide-btn-${index}`).style.display = 'none';
            document.querySelector(`.hide-btn-${index}`).style.display = 'inline-block';
        })
    })
            ...
            <form id="login-form">
                ...
                <div className="form-group mt-4">
                    ...
                    <div className={styles['enter-password-container']}>
                        ...
                        <FaEye id="unhide-btn-0" className={styles['unhide-password-button']}/>
                        <FaEyeSlash id="hide-btn-0" className={styles['hide-password-button']}/>
                    </div>
                </div>

                {
                    ...
                    <div className="form-group mt-4">
                        ...
                        <div className={styles['enter-password-container']}>
                            ...
                            <FaEye id="unhide-btn-1" className={styles['unhide-password-button']}/>
                            <FaEyeSlash id="hide-btn-1" className={styles['hide-password-button']}/>
                        </div>
                    </div>
                }
