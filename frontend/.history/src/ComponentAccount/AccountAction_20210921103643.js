...
const AccountAction = (props) => {
    ...
    const switchPasswordTypeHandler = () => {
            ...
            <form id="login-form">
                ...
                <div className="form-group mt-4">
                    ...
                    <div className={styles['enter-password-container']}>
                        ...
                        <FaEye className={styles['unhide-password-password']} onClick={switchPasswordTypeHandler}/>
                        <FaEyeSlash className={styles['hide-password-password']} onClick={switchPasswordTypeHandler}/>
                    </div>
                </div>
