            ...
            <form id="login-form">
                ...
                <div className="form-group mt-4">
                    ...
                    <div className={styles['enter-password-container']}>
                        ...
                        <FaEye className={styles['unhide-password-button']} onClick={switchPasswordTypeHandler}/>
                        <FaEyeSlash className={styles['hide-password-button']} onClick={switchPasswordTypeHandler}/>
                    </div>
                </div>
