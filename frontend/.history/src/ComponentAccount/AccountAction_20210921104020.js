...
const AccountAction = (props) => {
    ...
    const unhidePasswordTypeHandler = () => {

    }

    const hidePasswordTypeHandler = () => {
            ...
            <form id="login-form">
                ...
                <div className="form-group mt-4">
                    ...
                    <div className={styles['enter-password-container']}>
                        ...
                        <FaEye className={styles['unhide-password-button']} onClick={unhidePasswordTypeHandler}/>
                        <FaEyeSlash className={styles['hide-password-button']} onClick={hidePasswordTypeHandler}/>
                    </div>
                </div>

                {
                    ...
                    <div className="form-group mt-4">
                        ...
                        <div className={styles['enter-password-container']}>
                            <input type="password" className={inputTagClassName} id="eval-password" name="eval-password" placeholder="Nhập lại mật khẩu" required/>
                            <FaEye className={styles['unhide-password-button']} onClick={unhidePasswordTypeHandler}/>
                            <FaEyeSlash className={styles['hide-password-button']} onClick={hidePasswordTypeHandler}/>
                        </div>
                    </div>
