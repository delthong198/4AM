...
const RegisterForm = (props) => {
    ...
    const checkMatchedEvalPasswordOnInput = (e) => {
    ...
    return (
        <div className={styles['form-container']}>
            <form className={styles['form-group']}>
                ...
                <div className={`form-group mt-4 ${styles['form-input']}`}>
                    <div className={styles['enter-password-container']}>
                        <input type={showEvalPassword ? "text" : "password"} className={inputTagClassName} id="eval-password pass1" name="eval-password" placeholder="Nhập lại mật khẩu" onChange={checkMatchedEvalPasswordOnInput} onBlur={checkMat} required/>
