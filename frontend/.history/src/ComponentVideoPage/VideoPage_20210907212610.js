        ...
        <div className={styles['video-category-container']}>
            <div className={`${styles['video-category']} card-deck`}>
                <div className={`${styles['video-category-item']} card`}>
                    <img className={`${styles['video-category-item-img']} card-img-top`} src={basketballImg} alt="Card cap"/>
                    <div className={`${styles['video-category-item-body']} card-body`}>
                ...
                <div className={`${styles['video-category-item']}`}>
                    <img className={`${styles['video-category-item-img']} card-img-top`} src={calisthenicImg} alt="Card cap"/>
                    <div className={`${styles['video-category-item-body']} card-body`}>
