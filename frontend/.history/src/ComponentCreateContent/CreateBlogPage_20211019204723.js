        ...
        <div className={styles['create-blog-page']}>
            <div className={styles['form-container']}>
                <form onSubmit={handleSubmit(onSubmit)} className={styles['form-group']}>
                    ...
                    <div className={`form-group mt-4 ${styles['form-input']} ${styles['blog-content-input']}`}>
                        <textarea className={inputTagClassName} id="BlogContent" name="BlogContent" placeholder="Nhập nội dung" {...register('BlogContent', {required: true})}></textarea>
                    </div>
