            ...
            <div className={styles['form-container']}>
                <form onSubmit={handleSubmit(onSubmit)} className={styles['form-group']}>
                    ...
                    <div className={styles['title-and-type']}>
                        ...
                        <div className={`form-group mt-4 ${styles['form-input']} ${styles['blog-type-input']}`}>
                    ...
                    <div className={`form-group mt-4 ${styles['form-input']}`}>
                        <input type='file' className={inputTagClassName + ` ${styles['blog-content-input']}`} id="BlogImage" name="BlogImage" {...register('BlogImage', {required: true})}/>
                    </div>
