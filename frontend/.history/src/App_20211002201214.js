    ...
    <Router>
      <div className="App">
          ...
          <Switch>
              ...
              <Route path="/blog-category/basketball/:id">
                <Header />
                <Blog />
                <Footer />
              </Route>
              <Route path="/blog-category/calisthenic/:id">
                <Header />
                  <Blog />
                <Footer />
              </Route>

              <Route path="/video-category/basketball/:id">
                <Header />
                <Video />
                <Footer />
              </Route>
              <Route path="/video-category/calisthenic/:id">
                <Header />
                <Video />
                <Footer />
              </Route>
