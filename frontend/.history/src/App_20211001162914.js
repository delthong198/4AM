    ...
    <Router>
      <div className="App">
          ...
          <Switch>
              ...
              <Route path="/blog-category/basketball/:id" children={<Header/>, <Blog />}>
                <Header />
              </Route>
              <Route path="/blog-category/calisthenic/:id" children={<Header/>, <Blog />}>
                <Header />
              </Route>

              <Route path="/video-category/basketball/:id" children={<Header/>, <Video />}>
                <Header />
              </Route>
              <Route path="/video-category/calisthenic/:id" children={<Header/>, <Video />}>
                <Header />
              </Route>
